...
Queries to our full-text search engine can be words or phrases. In addition, they can contain a special wildcard symbol \textbf{\%} at the start or end of a word to search for parts of words. At this time, we do not support full regular expressions nor exact phrase matches.
