...
We created Lucy.js in JavaScript, as the IndexedDB API is also a JavaScript API. The code consists of four main files - \texttt{lucy.js}, \texttt{invindex.js}, \texttt{trieindex.js},  and \texttt{trieindex-hybrid.js} plus some third-party files that the user must include in their HTML file. The user should also additionally add one of the \texttt{<language>\_stopwords.js} files in order to pick a language to check stopwords on.
