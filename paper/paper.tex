...
Today, many applications on the web use a combination of client-side and server-side data stores to facilitate fast interactive and data-intensive experiences. 
...
displayable with \LaTeX (See Figures  and  ).  More details on each of these is found in the
