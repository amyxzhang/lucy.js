...
From our findings, we determine that client-side search engines are indeed feasible to build and have reasonable performance on 
 could be very useful for the right application and 
